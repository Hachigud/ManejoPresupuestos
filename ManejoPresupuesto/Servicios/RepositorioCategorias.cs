...
namespace ManejoPresupuesto.Servicios
{
    ...
    public class RepositorioCategorias: IRepositorioCategorias
    {
        ...
        {
            using var connection = new SqlConnection(connectionString);
            return await connection.QueryFirstOrDefaultAsync<Categoria>(@"SELECT * FROM Categorias WHERE IdCategoria = @Id AND UsuarioId = @UsuarioId ", new {id, usuarioId });
        }
        ...
        public async Task Actualizar(Categoria categoria)
        {
            ...
            await connection.ExecuteAsync(@"UPDATE Categorias SET Nombre = @Nombre, TipoOperacionId = @TipoOperacionId WHERE IdCategoria =@IdCategoria", categoria);
        }
        ...
        {
            using var connection = new SqlConnection(connectionString);
            await connection.ExecuteAsync("DELETE Categorias WHERE IdCategoria = @Id", new { id });
        }
