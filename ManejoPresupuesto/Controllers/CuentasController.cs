...
namespace ManejoPresupuesto.Controllers
{
    public class CuentasController: Controller
    {
        ...
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var cuenta = await repositorioCuentas.ObtenerPorId(cuentaEditar.IdCuentas, usuarioId);
            if (cuenta is null)
            {
                return RedirectToAction("NoEncontrado", "Home");
            }
        ...
        [HttpPost]
        public async Task<IActionResult> BorrarCuenta(int IdCuentas)
        {
            var usuarioId = servicioUsuarios.ObtenerUsuarioId();
            var cuenta = await repositorioCuentas.ObtenerPorId(IdCuentas, usuarioId);
            ...
            await repositorioCuentas.Borrar(IdCuentas);
            return RedirectToAction("Index");
        }
